<div class="dishes-content ">
    <button type="button" data-toggle="modal" data-target="#exampleModalCenter-lunch-<?php echo get_post_field('post_name', get_post())?>">
...
<div class="modal fade" id="exampleModalCenter-lunch-<?php echo get_post_field('post_name', get_post()) ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
